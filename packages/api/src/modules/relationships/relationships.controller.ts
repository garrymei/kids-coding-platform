...
export class RelationshipsController {
  ...
  async requestParentAccess(@Request() req, @Body() requestDto: RequestParentAccessDto) {
    return this.relationshipsService.requestParentAccess(req.user.userId, requestDto);
  }
  ...
  @ApiResponse({ status: 201, description: '申请提交成功' })
  async requestTeacherAccess(@Request() req, @Body() requestDto: RequestTeacherAccessDto) {
    return this.relationshipsService.requestTeacherAccess(req.user.userId, requestDto);
  }
  ...
  async respondToAccessRequest(@Request() req, @Body() responseDto: RespondToAccessRequestDto) {
    return this.relationshipsService.respondToAccessRequest(req.user.userId, responseDto);
  }
  ...
  async getRelationships(@Request() req) {
    return this.relationshipsService.getRelationships(req.user.userId, req.user.role);
  }
  ...
  async updateRelationship(
    ...
    return this.relationshipsService.updateRelationship(relationshipId, req.user.userId, updateDto);
  }
  ...
  async updateAccessGrant(
    ...
    return this.relationshipsService.updateAccessGrant(grantId, req.user.userId, updateDto);
  }
  ...
  async revokeAccessGrant(@Request() req, @Param('id') grantId: string) {
    return this.relationshipsService.revokeAccessGrant(grantId, req.user.userId);
  }
  ...
  @ApiQuery({ name: 'scope', description: '权限范围', example: 'progress:read' })
