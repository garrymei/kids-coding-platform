export class EventSeqStrategy {
    ...
    try {
      ...
      return {
        ...
        message: comparison.passed
          ? 'Event sequence matches expected'
  ...
  normalizeExpectedEvents(expected) {
    ...
    if (expected && typeof expected === 'object') {
      ...
      if (Array.isArray(obj.events)) {
        return obj.events.map((e) => String(e));
      }
      if (Array.isArray(obj.expect)) {
        return obj.expect.map((e) => String(e));
      }
      if (Array.isArray(obj.sequence)) {
        return obj.sequence.map((e) => String(e));
      }
    }
  ...
  compareEventSequences(expected, actual) {
